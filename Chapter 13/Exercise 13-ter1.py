# From https://www.w3resource.com/python-exercises/pyqt/python-pyqt-widgets-exercise-8.php
...
class TemperatureConverterApp(QMainWindow):
    def __init__(self):
        ...
        # Create a convert button and a Clear button
        convert_button = QPushButton("Convert")
        convert_button.clicked.connect(self.convert_temperature)
        clear_button = QPushButton("Clear")
        clear_button.clicked.connect(self.clear_temperature)
        ...
        # Create layout for temperature input, result and clear
